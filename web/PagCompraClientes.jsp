...
<html>
    ...
    <body class="homepage" >
        <%@include file="jspf/NavegacionAdministrador_Compra.jsp" %>
        <div id="resultado">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="container">
                        ...
                        <h3><strong>Fecha de Pedido : </strong><span id="fecha"> 12/02/2020</span></h3>
    ...
    <script type="text/javascript">
                                ...
                                function CargarDatos(nro, fecha, estado) {
                                    ...
                                    $("#nro").html(nro);
                                    $("#fecha").html(fecha);
                                    $("#estado").html(estado === true ? "Cancelado" : "Pendiente");
                                ...
                                function Carga() {
                                    $("#resultado").load("listado_pag/CompraCliente.jsp");
