        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="ControllerCarrito?accion=IrListaCarrito">Carrito</a></li>

                    <li class="dropdown">
                        <a  class="dropdown-toggle" data-toggle="dropdown">Mi Cuenta <i class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="PagIniciarSesion.jsp">Iniciar Sesion</a></li>
                            <li><a href="PagRegistro.jsp">Registrarse</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
